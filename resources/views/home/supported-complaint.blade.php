...
@if ($supported_complaints->isNotEmpty())
    ...
    <div class="container-card flex flex-col gap-4">
        ...
        <a href="aduan-didukung/{{$complaint->id}}" class="w-full bg-customgray2 flex rounded-[16px] overflow-hidden bg-opacity-80 hover:bg-opacity-100 flex-col lg:flex-row md:flex-row relative shadow-sm">
