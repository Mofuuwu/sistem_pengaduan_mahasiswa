...
<div class="bg-customblue p-[3%] flex items-center justify-center w-full shadow-xl rounded-[12px] max-w-md ">
  <div class="max-w-md w-full">
    ...
    <div class="mb-6">
      ...
      <input type="text" id="name" name="name" placeholder="Masukkan Nama Anda" value="{{$profile->name}}" class="w-full px-4 py-2 border-2 border-blue-400 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
    </div>

    <!-- Deskripsi -->
    <div class="mb-6">
      <label for="email" class="block text-white font-semibold mb-2">Email</label>
      <input type="text" id="email" name="email" placeholder="Masukkan Email Anda" value="{{$profile->email}}" class="w-full px-4 py-2 border-2 border-blue-400 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"></input>
    </div>

    <div class="mb-6">
      <label for="password" class="block text-white font-semibold mb-2">Password</label>
      <input type="text" id="password" name="password" placeholder="Masukkan Password Baru" class="w-full px-4 py-2 border-2 border-blue-400 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"></input>
    </div>
    ...
    <div class="mt-6 flex flex-col gap-2">
      ...
      <button class="w-full py-2 bg-blue-500 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 font-inter font-bold">Simpan Profil</button>
    </div>
  </div>
</div>
</section>
